...
HD_PWD='C:/Users/jungu/Desktop/AiSys/AiSys_cpu/cpu/Assign 7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_io.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_io.tcl
